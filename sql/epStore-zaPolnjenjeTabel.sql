...
INSERT INTO `artikel` VALUES (1,'Nogavice',4,0,'st. 46'),(2,'majica',15.13,1,'XL'),(3,'majica',10,1,'L'),(4,'majica',15,1,'asd'),(5,'Pulover',30,0,'XL'),(6,'majica',41,1,'214'),(7,'majica',12,1,'safsdg'),(8,'majica',15,1,'maijca'),(9,'majica',15,1,'gh'),(10,'Banana',0.5,1,'njam');
...
INSERT INTO `stranka` VALUES ('janez.novak@gmail.com','Janez','Novak','$2y$10$2B1oLdxaB/baKd./7in8XunWrPtEZGquFb1dmz3AMyZrliR0Ssz3W',1,10,1,'Hrenova ulica 6','040555555'),('franc.kosir@gmail.com','Franc','Košir','$2y$10$Im.V035a/.QNyvhLE5EOROq1vK77S34X26mVuwtBa6nalMzqkXejq',1,11,7,'Gozdna cesta 3','030888888');
...
INSERT INTO `zaposlenec` VALUES ('godfather@corleone.it','Don Vito','Corleone','$2y$10$2M2S7Cwa6Xo8sKtfnY114OdmE3MYwAzwX7sNsVl4FrTBDhH3yaj2G',1,1,1),('consigliere@corleone.it','Tom','Hagen','$2y$10$cUinHBcbc2qbpKiMT3MPMeYM2h3I82J.NLXx.tWezCgQlBkWRAz4m',2,1,0);
...
-- Dump completed on 2016-12-29 13:43:40
